...
export function Sidebar({ className, projectId, project }: SidebarProps) {
  ...
  return (
    <div
      className={cn(
        "w-60 min-h-screen pb-12 border-r bg-white/80 backdrop-blur-sm",
        className,
      )}
    >
      <div className="space-y-4 py-4">
        <div className="px-4 py-2">
          ...
          <div className="mb-6 px-3 py-2 bg-sylvia-50 rounded-md border border-sylvia-100">
            <h3 className="font-medium text-sylvia-800 truncate">
              {project.name}
            </h3>
            <div className="text-xs text-sylvia-600 mt-1">
                    ...
                    {index < routes.length - 1 && (
                      <div
                        className={cn(
                          ...
                          route.completed ? "bg-green-300" : "bg-gray-200",
                        )}
                      />
                    )}
                  </div>
