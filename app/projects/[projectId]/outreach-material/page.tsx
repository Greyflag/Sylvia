...
export default function OutreachMaterialPage() {
  ...
  const handleGenerate = async () => {
    ...
    const tone =
      (document.getElementById("tone") as HTMLSelectElement)?.value ||
      "professional";
    const audience =
      (document.getElementById("audience") as HTMLSelectElement)?.value ||
      "enterprise";
    const surveyLength =
      (document.getElementById("survey-length") as HTMLSelectElement)?.value ||
      "medium";
    const incentive =
      (document.getElementById("incentive") as HTMLSelectElement)?.value ||
      "none";

    // Generate content for each email type
    const initialContent = generateInitialEmail(
      tone,
      audience,
      surveyLength,
      incentive,
    );
    const reminderContent = generateReminderEmail(
      tone,
      audience,
      surveyLength,
      incentive,
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Create and customize your survey invitation emails
          </p>
        </div>
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="sm:max-w-[600px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Let Sylvia help you create professional email templates
      ...
      {isCompleted ? (
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-2 text-green-600 mb-2">
              ...
              <h2 className="text-lg font-medium">
                Outreach Material Complete
              </h2>
            </div>
            <p className="text-muted-foreground mb-4">
              Email templates have been finalized and used in the survey
              campaign. View the templates below.
            </p>
        ...
        <Card className="bg-white/50 border">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground mb-4">
              Create compelling email templates to invite participants to your
              survey. Good outreach materials increase response rates and
              engagement.
            </p>
